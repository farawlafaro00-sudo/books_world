...
$sel_books = "SELECT * FROM books WHERE id = $id ";
$result = $pdo->query($sel_books);
$row_books = $result->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="icon" href="../img/222.png">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb" style="background-color:antiquewhite;">
                <li><a href="#">
                        <em class="fa fa-pencil" style="color:brown;"></em>
                    </a></li>
                <li class="active" style="color:black;">edit-book</li>
            </ol>
        </div><!--/.row-->

        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:brown; text-transform:uppercase;">edit-book</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="panel panel-container" style="background-color:antiquewhite;">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <form action="../fun/do-edit-book.php?id=<?= $row_books['id'] ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control"
                                style="border-radius:8px; border:1px solid #915831;" value="<?= $row_books['name']; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img src="../img/<?= $row_books['image'] ?>" alt="<?= $row_books['name'] ?>" style="width:80px; height:80px;">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="auther" class="form-control"
                                style="border-radius:8px; border:1px solid #915831;" value="<?= $row_books['auther']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label style="color:#915831; font-weight:bold;">Book Description</label>
                            <textarea class="form-control" name="descr" rows="4"
                                style="border-radius:8px; border:1px solid #915831;"><?= $row_books['desc']; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label style="color:#915831; font-weight:bold;">Type</label>
                            <input type="text" name="type" class="form-control"
                                style="border-radius:8px; border:1px solid #915831;" value="<?= $row_books['type']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label style="color:#915831; font-weight:bold;">Price</label>
                            <input type="text" name="price" class="form-control"
                                style="border-radius:8px; border:1px solid #915831;" value="<?= $row_books['price']; ?>" required>
                        </div>
